...
<div class="mb-3">
  <label for="input_logo" class="form-label">Image mise en avant du Design</label>
  <input class="form-control"  name="design_logo" type="file" id="formFile" placeholder="Image mise en avant du Design">
</div>
<div class="mb-3">
