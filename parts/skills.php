    ...
    <div class='modal_skills_content '>
        <div  class='modal_skills_content--child '>
            ...
            <span><p class='demo cursor' onclick="currentSlide(2)">Développement web</p></span>
            <span><p class='demo cursor' onclick="currentSlide(3)">Logiciels et technologie</p></span>
        </div>
